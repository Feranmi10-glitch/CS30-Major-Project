...
function playGame(){
    if(gridArray[0] === "r" && gridArray[1] ==="a" && gridArray[2] === "t"||
      gridArray[0] === "a" && gridArray[1]==="t" && gridArray[2] === "e"||
      gridArray[0] === "t" && gridArray[1]==="e" && gridArray[2] === "a"&&
      gridArray[3] === "r" && gridArray[4]==="a" && gridArray[5] === "t"||
      gridArray[3] === "a" && gridArray[4]==="t" && gridArray[5] === "e"||
      gridArray[3] === "t" && gridArray[4]==="e" && gridArray[5] === "a"&&
      gridArray[6] === "r" && gridArray[7]==="a" && gridArray[8] === "t"||
      gridArray[6] === "a" && gridArray[7]==="t" && gridArray[8] === "e"||
      gridArray[6] === "t" && gridArray[7]==="e" && gridArray[8] === "a"&&
      gridArray[9] === "w" && gridArray[10]==="a" && gridArray[11] === "t"&& gridArray[12] ==="e" && gridArray[13]==="r")
      {
        return winGame();
      }
    else{
