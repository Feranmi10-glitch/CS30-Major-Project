...
function playGame(){
    if(gridArray[0] === "h" && gridArray[1] ==="a" && gridArray[2] === "s"||
      gridArray[0] === "s" && gridArray[1]==="a" && gridArray[2] === "c"||
      gridArray[0] === "a" && gridArray[1]==="s" && gridArray[2] === "h"&&
      gridArray[3] === "h" && gridArray[4]==="a" && gridArray[5] === "s"||
      gridArray[3] === "s" && gridArray[4]==="a" && gridArray[5] === "c"||
      gridArray[3] === "a" && gridArray[4]==="s" && gridArray[5] === "h"&&
      gridArray[6] === "h" && gridArray[7]==="a" && gridArray[8] === "s"||
      gridArray[6] === "s" && gridArray[7]==="a" && gridArray[8] === "c"||
      gridArray[6] === "a" && gridArray[7]==="s" && gridArray[8] === "h"&&
      gridArray[9] === "c" && gridArray[10]==="l" && gridArray[11] === "a"&& gridArray[12] ==="s" && gridArray[13]==="h")
      {
        return winGame();
      }
    else{
