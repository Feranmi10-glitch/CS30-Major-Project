...
function playGame(){
    if(gridArray[0] === "n" && gridArray[1] ==="o" && gridArray[2] === "d"||
      gridArray[0] === "r" && gridArray[1]==="e" && gridArray[2] === "d"||
      gridArray[0] === "o" && gridArray[1]==="n" && gridArray[2] === "e"&&
      gridArray[3] === "r" && gridArray[4]==="e" && gridArray[5] === "d"||
      gridArray[3] === "r" && gridArray[4]==="e" && gridArray[5] === "d"||
      gridArray[3] === "r" && gridArray[4]==="e" && gridArray[5] === "d"&&
      gridArray[6] === "r" && gridArray[7]==="e" && gridArray[8] === "d"||
      gridArray[6] === "r" && gridArray[7]==="e" && gridArray[8] === "d"||
      gridArray[6] === "r" && gridArray[7]==="e" && gridArray[8] === "d"&&
      gridArray[9] === "d" && gridArray[10]==="r" && gridArray[11] === "o"&& gridArray[12] ==="n" && gridArray[13]==="e")
      {
        return winGame();
      }
    else{
